...
export default function ExamCountdownSidebar({ exams, subjects, onAddExamClick }: ExamCountdownSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block w-56 sticky top-8 self-start">
        <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold text-gray-400">Upcoming Exams</h2>
            <button onClick={onAddExamClick} className="text-sm text-cyan-400 hover:underline">+ Add Exam</button>
        </div>
